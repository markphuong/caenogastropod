...
def align(element):
	...
	cp {sample}_phylo_contigs.fa /pylon2/bi4s86p/phuong/caenogastropod/9blastagain/
	cp {sample}.filtered_results /pylon2/bi4s86p/phuong/caenogastropod/9blastagain/
	""".format(**variables)
