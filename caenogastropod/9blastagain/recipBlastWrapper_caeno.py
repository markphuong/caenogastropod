...
def align(element):
	...
	blastx -query {sample}_assemblies_clustered.fasta.NI -db final_lottia_ref.fa -outfmt 6 -out {sample}.blastx -evalue 1e-10 -num_threads 10
	tblastn -query final_lottia_ref.fa -db {sample}_assemblies_clustered.fasta.NI -outfmt 6 -out {sample}.tblastn -evalue 1e-10 -num_threads 10
	""".format(**variables)
