...
#                cmd = 'cp /pylon2/bi4s86p/phuong/caenogastropod/16aliscore/filtered/' + thing + ' ./'
#                os.system(cmd)
...
#		cmd = 'cp ' + thing + ' /pylon2/bi4s86p/phuong/caenogastropod/17pdist/mytest2'
#               os.system(cmd)
...
for item in pdistdict:
	...
	out.write(item + '\t' + str(numpy.percentile(pdistdict[item],95)) + '\n')
