...
# some names for input output files
	...
	read1 = '/pylon2/bi4s86p/phuong/caenogastropod/6merge_reads/' + ID + r1name,
	read2 = '/pylon2/bi4s86p/phuong/caenogastropod/6merge_reads/' + ID + r2name,
	unpaired = '/pylon2/bi4s86p/phuong/caenogastropod/6merge_reads/' + ID + uname,
