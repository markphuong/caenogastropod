...
def align(element):
	...
	uname = '_sed_finalunpaired.fq' #extension of unpaired reads
...
# some names for input output files
	...
	unpaired = '/pylon2/bi4s86p/phuong/caenogastropod/2trimmed/' + ID + uname,
...
# 10. create a VCF file
	...
	commands = """
	cp /pylon2/bi4s86p/phuong/caenogastropod/9blastagain/{ref} ./
	...
	samtools sort -@ 15 -o {outfile}_5.1.bam -O bam {out_unpaired}.bam 
	...
	rm {out_unpaired}.sam {out_unpaired}.bam
	mv {sample}* /pylon2/bi4s86p/phuong/caenogastropod/10mapping
	""".format(**variables)
