...
def align(element):
	...
	blastx -query {sample}_assemblies_clustered.fasta.NI -db Lotgi1_GeneModels_FilteredModels1_aa.fasta -outfmt 6 -out {sample}.blastx -evalue 1e-10
	tblastn -query Lotgi1_GeneModels_FilteredModels1_aa.fasta -db {sample}_assemblies_clustered.fasta.NI -outfmt 6 -out {sample}.tblastn -evalue 1e-10
	""".format(**variables)
