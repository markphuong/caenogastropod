...
def align(element):
	...
	read1 = element + '_R1.fq.gz',
	read2 = element + '_R2.fq.gz',
	...
	commands = """
	java -jar $TRIMMOMATIC_HOME/trimmomatic-0.36.jar PE -threads 63 -phred33 {read1} {read2} {read1out} {read1unpairedout} {read2out} {read2unpairedout} ILLUMINACLIP:{adfile}:2:40:15 SLIDINGWINDOW:4:20 MINLEN:36 LEADING:15 TRAILING:15 > {sampleID}.trimm 2> {sampleID}.trimmerr
	cat {read1out} {read1unpairedout} {read2unpairedout} > {sampleID}_final1.fq
	cat {read2out} > {sampleID}_final2.fq
